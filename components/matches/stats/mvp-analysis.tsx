          ...
          <div className="flex items-center justify-center p-6 bg-primary/5 rounded-lg">
            <div className="text-center">
              <Avatar className="w-20 h-20 mx-auto mb-4">
                ...
                <AvatarFallback>
                  {matchMVP.player.name.split(" ").map(n => n[0]).join("")}
                </AvatarFallback>
              </Avatar>
              ...
              <p className="text-lg font-medium mt-2">{matchMVP.player.name}</p>
              <p className="text-sm text-muted-foreground mt-1">Score: {matchMVP.score.toFixed(2)}</p>
            </div>
          </div>
              ...
              <div key={mvp.setNumber} className="flex items-center justify-between p-4 border rounded-lg">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Set {mvp.setNumber}</p>
                  </div>
                </div>
